...
def load_agent(llm, tools):
    custom_prompt = """
    You are an intelligent agent that can answer questions about various subjects. You have access to a large amount of information about Biology, Chemistry, Physics, Mathematics, and Computer Science. You can answer questions about these subjects to the best of your ability. You can also ask clarifying questions if you need more information to answer a question. You can ask up to 20 clarifying questions.

    If you require a tool which does not exist, you can say "I don't know" or "I can't answer that question" to skip it.
